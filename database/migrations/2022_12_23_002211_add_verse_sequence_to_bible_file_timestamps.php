...
return new class extends Migration
{
    ...
    public function up()
    {
        $table_name = 'bible_file_timestamps';
        ...
        \DB::connection('dbp')->statement(
            "ALTER TABLE $table_name modify column verse_end char(10) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL"
        );
    }
    ...
    public function down()
    {
        ...
        \DB::connection('dbp')->statement(
            "ALTER TABLE $table_name modify column verse_end tinyint unsigned DEFAULT NULL"
        );
    }
};
