...
// NOTE: See the default file, config.php, if you want to add more languages:
...
return [
    ...
    //
    // Automatically determine locale from browser
    ...
    // LanguageNegotiator to assign the descired locales based on HTTP Accept Language Header. For example you want ot
    // use 'at', so map HTTP Accept Language Header 'de-AT' to 'at' (['de-AT' => 'at']).
    'localesMapping' => [],
